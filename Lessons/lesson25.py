...
# Задание 1: Использование оператора %
team1_num = 6
print("В команде участников: %d !" % team1_num)

# Задание 2: Использование оператора %
team1_num = 6
team2_num = 3
print("Итого сегодня в командах участников: %d и %d !" % (team1_num, team2_num))

# Задание 3: Использование метода format()
score_2 = 42
print("Команда Волшебники данных решила задач: {} !".format(score_2))

# Задание 4: Использование метода format()
team1_time = 18015.2
print("Волшебники данных решили задачи за {:.2f} с !".format(team1_time))

# Задание 5: Использование f-строк
score_1 = 40
print(f"Команды решили {score_1} и {score_2} задач.")

# Задание 6: Использование f-строк
challenge_result = 'Победа команды!'
print(f"Результат битвы: {challenge_result}!")

# Задание 7: Использование f-строк
tasks_total = 82
time_avg = 350.4
